...
(*CLEARED*)
  Coercion base2 T (M:T -> T -> cppoType) (c:class_of M) := CatTerminal.Class c. (*CLEAR*)

  Structure cat := Pack {object :> Type; morph : object -> object -> cppoType ; _ : class_of morph; _ : Type}.
